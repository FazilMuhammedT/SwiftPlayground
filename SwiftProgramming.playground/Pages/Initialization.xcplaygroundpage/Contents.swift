...
// this reports a compile-time error - Missing argument labels 'red:green:blue:' in call
//:
...
//: The initializer call `Celsius2(37.0)` is clear in its intent without the need for an argument label. It is therefore appropriate to write this initializer as `init(_ celsius: Double)` so that it can be called by providing an unnamed `Double` value.
//:
...
//:
//: ![Initializer Delegation](initializerDelegation02_2x.png)
//:
...
//:
//: ![Two Phase Initialization](twoPhaseInitialization01_2x.png)
//:
...
//:
//: ![Two Phase Initialization 02](twoPhaseInitialization02_2x.png)
//:
...
//:
//: ![Initializers Example](initializersExample01_2x.png)
//:
...
//:
//: ![Initializers Example 02](initializersExample02_2x.png)
//:
...
//:
//: ![Initializers Example 03](initializersExample03_2x.png)
//:
