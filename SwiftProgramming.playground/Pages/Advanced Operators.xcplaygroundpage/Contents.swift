...
//:
//: ![bitwiseNOT_2x.png](bitwiseNOT_2x.png)
//:
...
//:
let initialBits: UInt8 = 0b00001111 // 8+4+2+1 -> 15
let invertedBits = ~initialBits  // equals 11110000 - 128+64+32+16 -> 240
//:
...
//:
//: ![bitwiseAND_2x.png](bitwiseAND_2x.png)
//:
...
//:
//: ![bitwiseOR_2x.png](bitwiseOR_2x.png)
//:
...
//:
//: ![bitwiseXOR_2x.png](bitwiseXOR_2x.png)
//:
...
//:
//: ![bitshiftUnsigned_2x.png](bitshiftUnsigned_2x.png)
//:
...
//:
//: ![bitshiftSignedFour_2x.png](bitshiftSignedFour_2x.png)
//:
...
//:
//: ![bitshiftSignedMinusFour_2x.png](bitshiftSignedMinusFour_2x.png)
//:
//: This time, the sign bit is `1` (meaning “negative”), and the seven value bits have a binary value of `124` (which is `128 - 4`):
//:
//: ![bitshiftSignedMinusFourValue_2x.png](bitshiftSignedMinusFourValue_2x.png)
//:
...
//:
//: ![bitshiftSignedAddition_2x.png](bitshiftSignedAddition_2x.png)
//:
...
//:
//: ![bitshiftSigned_2x.png](bitshiftSigned_2x.png)
//:
...
//:
//: ![overflowAddition_2x.png](overflowAddition_2x.png)
//:
...
//:
//: ![overflowUnsignedSubtraction_2x.png](overflowUnsignedSubtraction_2x.png)
//:
...
//:
//: ![overflowSignedSubtraction_2x.png](overflowSignedSubtraction_2x.png)
//:
...
//:
//: ![vectorAddition_2x.png](vectorAddition_2x.png)
//:
...
//: ## Custom Operators
//:
//: You can declare and implement your own *custom operators* in addition to the standard operators provided by Swift. For a list of characters that can be used to define custom operators, see [Operators](https://docs.swift.org/swift-book/ReferenceManual/LexicalStructure.html#ID418).
//:
