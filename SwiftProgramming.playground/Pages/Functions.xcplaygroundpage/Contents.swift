...
//:
//: To handle an empty array safely, write the `minMax1(array:)` function with an optional tuple return type and return a value of `nil` when the array is empty:
...
//: You can use optional binding to check whether this version of the `minMax1(array:)` function returns an actual tuple value or `nil`:
