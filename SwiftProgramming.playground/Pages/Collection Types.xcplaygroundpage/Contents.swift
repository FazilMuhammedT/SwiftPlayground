...
//:
//: ![Collection Types Intro](CollectionTypes_intro_2x.png)
//:
...
//:
//: The example below creates a set called `favoriteGenresSet` to store String values:
var favoriteGenresSet: Set<String> = ["Rock", "Classical", "Hip hop"]
// favoriteGenresSet has been initialized with three initial items
//: The `favoriteGenresSet` variable is declared as “a set of String values”, written as Set<String>. Because this particular set has specified a value type of `String`, it is *only* allowed to store `String` values. Here, the `favoriteGenresSet` set is initialized with three String values ("Rock", "Classical", and "Hip hop"), written within an array literal.
//: - NOTE:
...
//:
//: A set type cannot be inferred from an array literal alone, so the type Set must be *explicitly declared*. However, because of Swift’s type inference, you don’t have to write the type of the set’s elements if you’re initializing it with an array literal that contains values of just one type. The initialization of `favoriteGenresSet` could have been written in a shorter form instead:
//var favoriteGenresSet: Set = ["Rock", "Classical", "Hip hop"]
...
print("I have \(favoriteGenresSet.count) favorite music genres.")
// Prints "I have 3 favorite music genres."
//: Use the Boolean `isEmpty` property as a shortcut for checking whether the `count` property is equal to `0`:
if favoriteGenresSet.isEmpty {
...
if let removedGenre = favoriteGenresSet.remove("Rock") {
...
if favoriteGenresSet.contains("Funk") {
...
for genre in favoriteGenresSet {
    print("\(genre)")
}
// Classical
// Jazz
...
//:
//: ![Set Venn Diagram](setVennDiagram_2x.png)
//:
...
//:
//: ![Set Euler Diagram](setEulerDiagram_2x.png)
//:
