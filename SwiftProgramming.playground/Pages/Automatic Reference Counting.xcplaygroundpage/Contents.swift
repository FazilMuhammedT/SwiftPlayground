...
//:
//: There are now *three*ß strong references to this single `Person` instance.
//:
...
//:
//: ![referenceCycle01_2x.png](referenceCycle01_2x.png)
//:
...
//:
//: ![referenceCycle02_2x.png](referenceCycle02_2x.png)
//:
...
//:
//: ![referenceCycle03_2x.png](referenceCycle03_2x.png)
//:
...
//:
//: ![weakReference01_2x.png](weakReference01_2x.png)
//:
...
//:
//: ![weakReference02_2x.png](weakReference02_2x.png)
//:
...
//:
//: ![weakReference03_2x.png](weakReference03_2x.png)
//:
//: - NOTE:
...
//:
//: ![unownedReference01_2x.png](unownedReference01_2x.png)
//:
...
//:
//: ![unownedReference02_2x.png](unownedReference02_2x.png)
//:
...
//:
//: The initializer for `City` is called from within the initializer for `Country`. However, the initializer for `Country` cannot pass `self` to the `City` initializer until a new `Country` instance is fully initialized, as described in [Two-Phase Initialization](https://docs.swift.org/swift-book/LanguageGuide/Initialization.html#ID220).
//:
...
//:
//: ![closureReferenceCycle01_2x.png](closureReferenceCycle01_2x.png)
//:
...
//:
//: ![closureReferenceCycle02_2x.png](closureReferenceCycle02_2x.png)
//:
...
//:
//: For more information about capture lists, see [Capture Lists](https://docs.swift.org/swift-book/ReferenceManual/Expressions.html#ID544).
//:
//: [Memory Safety >](@next)
