...
//:
//: ![memory_shopping_2x.png](memory_shopping_2x.png)
//:
...
//increment(&stepSize)
// Error: conflicting accesses to stepSize - Simultaneous accesses to 0x118356040, but modification requires exclusive access.
...
//:
//: ![memory_increment_2x.png](memory_increment_2x.png)
//:
...
// Error: conflicting accesses to playerOneScore - error: inout arguments are not allowed to alias each other
//:
...
//:
//: ![memory_share_health_maria_2x.png](memory_share_health_maria_2x.png)
//:
//: However, if you pass `oscar` as the argument to `shareHealth(with:)`, there’s a conflict:
//:
//oscar.shareHealth(with: &oscar)
// Error: conflicting accesses to oscar - error: inout arguments are not allowed to alias each other
//:
...
//:
//: ![memory_share_health_oscar_2x.png](memory_share_health_oscar_2x.png)
//:
...
// Error: conflicting access to properties of playerInformation - Simultaneous accesses to 0x1171c3318, but modification requires exclusive access.
//:
...
// Error - Simultaneous accesses to 0x1223a8328, but modification requires exclusive access.
//:
