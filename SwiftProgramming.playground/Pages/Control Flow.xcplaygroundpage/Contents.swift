...
// spiders have 8 legs
//:
//: The contents of a `Dictionary` are inherently unordered, and iterating over them does not guarantee the order in which they will be retrieved. In particular, the order you insert items into a `Dictionary` doesn’t define the order they are iterated. For more about arrays and dictionaries, see [Collection Types](https://docs.swift.org/swift-book/LanguageGuide/CollectionTypes.html).
//:
...
print("\(base2) to the power of \(power) is \(answer2)")
...
//:
//: ![Snake and Ladders](snakesAndLadders_2x.png)
//:
...
//: - NOTE:
//: Although `break` is not required in Swift, you can use a `break` statement to match and ignore a particular case or to break out of a matched case before that case has completed its execution. For details, see [Break in a Switch Statement](https://docs.swift.org/swift-book/LanguageGuide/ControlFlow.html#ID139).
//:
...
//:
//: ![Coordinate Graph Simple](coordinateGraphSimple_2x.png)
//:
...
//:
//:
//: ![Snakes and Ladders](snakesAndLadders_2x.png)
//:
