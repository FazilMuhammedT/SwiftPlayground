...
var aNumber = 1
var anotherNumber = 2
swap(&aNumber, &anotherNumber)
print("aNumber = \(aNumber) anotherNumber = \(anotherNumber)")
//Prints "aNumber = 2 anotherNumber = 1"
//:
//: ## Type Parameters
//:
...
//:
//: ![stackPushPop_2x](stackPushPop_2x.png)
//:
...
//:
//: ![stackPushedFourStrings_2x](stackPushedFourStrings_2x.png)
//:
...
//:
//: ![stackPoppedOneString_2x.png](stackPoppedOneString_2x.png)
//:
...
var stackOfInts1 = Stack1<Int>()
stackOfInts1.append(10)
stackOfInts1.append(20)
stackOfInts1.append(30)
let suffix = stackOfInts1.suffix(2)
...
extension IntStack1: SuffixableContainer {
    ...
    // Inferred that Suffix is Stack1<Int>.
}
//:
